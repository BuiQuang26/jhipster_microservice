...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.quangbui26.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.quangbui26.security.DomainUserDetailsService", "createSpringSecurityUser");
