package com.quangbui26.gateway.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.quangbui26.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.quangbui26.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
