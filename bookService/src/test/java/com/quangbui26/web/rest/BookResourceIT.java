...
class BookResourceIT {
    ...
    public static Book createEntity(EntityManager em) {
        Book book = new Book().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).author(DEFAULT_AUTHOR);
        return book;
    }
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        Book book = new Book().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).author(UPDATED_AUTHOR);
        return book;
    }
    ...
    void putExistingBook() throws Exception {
        ...
        updatedBook.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).author(UPDATED_AUTHOR);
    ...
    void fullUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).author(UPDATED_AUTHOR);
